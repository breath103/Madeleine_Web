...
<head>
	...
	<script language="javascript" type="text/javascript">
		...
		function getRotationCSS( angle ) 
		{
			var strRotate = "rotate(" + angle + "deg)";
			return { "transform":strRotate,
					 "-ms-transform":strRotate, /* IE 9 */
				     "-moz-transform":strRotate, /* Firefox */
					 "-webkit-transform":strRotate, /* Safari and Chrome */
					 "-o-transform":strRotate};
		}
